...
*Please note* This library does not yet support interrupts, but you can still use them by attaching a RISING interrupt to the receive pin then immediately calling `recv` from the ISR
